...
# We know the old css had NAVBAR and HERO sections.
# Let's find "NAVBAR" and "VIEW 2" or "CONSOLE"
start_marker = '/* =========================================================================\n   NAVBAR'
end_marker = '/* =========================================================================\n   VIEW 2'
...
# If we can't find VIEW 2, try another marker for the terminal parts
if end_idx == -1:
    end_idx = css.find('/* =========================================================================\n   CONSOLE')

if end_idx == -1:
    # Just look for 'CONSOLE GRID' or similar
    end_idx = css.find('/* CONSOLE GRID')
...
.id-wireframe {
  ...
  gap: 20px;
  background: radial-gradient(circle at 100% 0%, #111 0%, #000 100%);
  transform: rotate(2deg) translateY(-20px);
  box-shadow: 0 40px 100px rgba(255,255,255,0.02);
}
